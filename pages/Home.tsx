...
// Fungsi untuk menghitung tahun ajaran secara otomatis.
// Jika bulan sekarang >= Oktober (bulan ke-10), tahun ajaran berikutnya sudah aktif.
// Contoh: Oktober 2026 → "2027/2028", Januari 2026 → "2026/2027"
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="animate-fadeIn">
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto mb-10 leading-relaxed font-medium">
              ...
              <span className="text-white font-bold">{academicYear}</span> telah
              dibuka. Daftarkan putra-putri Anda melalui sistem online kami yang
          ...
          <div className="bg-blue-600 rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-blue-600/40">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
              <div className="space-y-1">
                ...
                <div className="text-xs md:text-sm text-blue-100 font-bold tracking-widest">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 font-medium max-w-lg mx-auto leading-relaxed">
              Ikuti langkah-langkah mudah di bawah ini untuk mendaftarkan calon
              peserta didik baru.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              {
                title: 'Isi Formulir',
                desc: 'Lengkapi data pendaftar, data orang tua dan alamat lengkap dengan benar.',
                icon: 'M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z',
              },
              {
                title: 'Unggah Berkas',
                desc: 'Scan dokumen wajib seperti Akta, KK dan Rapor dalam format digital.',
                icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12',
              },
              {
                title: 'Verifikasi',
                desc: 'Tim panitia akan memvalidasi dokumen yang telah Anda unggah.',
                icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
              },
              {
                title: 'Cetak Bukti',
                desc: 'Simpan PDF bukti pendaftaran untuk dibawa saat melakukan tes wawancara.',
                icon: 'M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z',
              },
            ].map((step, idx) => (
              <div
                key={idx}
                className="group bg-white p-8 rounded-[2rem] text-center border border-slate-100 hover:border-blue-100 hover:shadow-2xl hover:shadow-blue-600/10 transition-all duration-500"
              >
                ...
                <div className="inline-block px-3 py-1 bg-blue-50 rounded-lg text-[10px] font-black text-blue-600 mb-4 uppercase tracking-widest">
                  Langkah {idx + 1}
                </div>
