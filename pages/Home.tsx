          ...
          <div className="bg-blue-600 rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-blue-600/40">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
              <div className="space-y-1">
                ...
                <div className="text-xs md:text-sm text-blue-100 uppercase font-bold tracking-widest">Lulusan Terserap Dunia Kerja</div>
              </div>
              <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <div className="text-xs md:text-sm text-blue-100 uppercase font-bold tracking-widest">Kompetensi Keahlian</div>
                <div className="text-xs md:text-sm text-blue-100 uppercase font-bold tracking-widest">(DKV, TKL, TO & TPFL)</div>
              </div>
            </div>
          </div>
        </div>
